				...
				<div className='col-span-4 pt-8 lg:pt-0'>
					<div className='pb-7 mb-7 border-b border-gray-300'>
						...
						<p className='text-body text-sm lg:text-base leading-6 lg:leading-8 dark:text-gray-300'>
							Children’s clothing/ kids wear is usually more
							casual than adult clothing, fit play and rest.
							Hosiery is usually used. More recently, however,
							tons of childrenswear is heavily influenced by
